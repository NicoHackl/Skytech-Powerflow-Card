...
> Verbindlich für die Darstellung der Karte. Architektur und Code-Muster stehen in
> [architektur.md](architektur.md), der Inhalt der Texte in [nutzertexte.md](nutzertexte.md) —
> beides wird hier nicht wiederholt. Hier steht nur das Aussehen: Tokens, Klassen, Zustände.
...
Umsetzung im Code: [architektur.md](architektur.md).
