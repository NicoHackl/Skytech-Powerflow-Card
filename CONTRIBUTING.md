...
5. [docs/nutzertexte.md](docs/nutzertexte.md) — was der Nutzer zu sehen bekommt, und was nicht.
6. [docs/test-strategie.md](docs/test-strategie.md) — was getestet werden muss.
